			...
			for (var i=0; i< videos.length; i++){
				if (videos[i].getAttribute('visible')==true){
					...
					if (i == videos.length-1){
						window.location="sharepath.html"
						return;
					}
					else{
						...
						//CK
						objects[0]=.setAttribute('visible', 'false');
						objects[1]=.setAttribute('visible', 'false');
						objects[2]=.setAttribute('visible', 'false');
						objects[3]=.setAttribute('visible', 'false');
						objects[4]=.setAttribute('visible', 'false');
						objects[5]=.setAttribute('visible', 'false');

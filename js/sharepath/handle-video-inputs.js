AFRAME.registerComponent('handle-video-inputs', {
    init: function () {
		...
		this.videosphere5 = document.querySelector('#videosphere5');
		this.videosphere6 = document.querySelector('#videosphere6');
		...
		this.video5 = videosphere5.components.material.material.map.image;
		this.video6 = videosphere6.components.material.material.map.image;
    }, 
    play: function () {
    ...
    onClick: function (evt) {
        ...
        if (this.videosphere1 && this.videosphere1.getAttribute('visible'))
            video = this.video1;
        else if (this.videosphere2 && this.videosphere2.getAttribute('visible'))
            video = this.video2;
		else if (this.videosphere3 && this.videosphere3.getAttribute('visible'))
            video = this.video3;
		else if (this.videosphere4 && this.videosphere4.getAttribute('visible'))
            video = this.video4;
		else if (this.videosphere5 && this.videosphere5.getAttribute('visible'))
            video = this.video5;
		else
            video = this.video6;
